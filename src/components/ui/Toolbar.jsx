...
export function Toolbar({ activeSection, onExportPDF, onExportDOCX, onExportJSON, onImportJSON, onExportCoverLetterPDF, onExportCoverLetterDOCX, exporting }) {
  ...
  return (
    <header className="bg-white border-b border-gray-200 flex-shrink-0">
      {/* Row 1: template switcher + export buttons */}
      <div className="h-12 flex items-center px-4 gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {isCoverLetter && (
            <>
              <span className="text-xs text-gray-400 font-medium mr-1">{t("toolbar.exportCoverLetter")}</span>
              <button
      ...
      {/* Row 2: designer palette sub-toolbar */}
      {template === "designer" && (
        <div className="h-9 flex items-center px-4 gap-2 bg-gray-50 border-t border-gray-100">
