        ...
        <div>
          ...
          {languages.map((l, i) => (
            <div key={i} style={{ marginBottom: "5px" }}>
              ...
              {l.level && (
                <p style={{ fontSize: "8px", color: C.muted }}>{l.level}</p>
              )}
            </div>
          ))}
        </div>
      ...
      {certifications.filter(Boolean).length > 0 && (
        <div>
          ...
          {certifications.filter(Boolean).map((cert, i) => (
            ...
            >
              <span style={{ color: C.accent, fontSize: "8px", flexShrink: 0 }}>
                ★
              </span>
              <span
                style={{ fontSize: "8.5px", color: C.body, lineHeight: 1.4 }}
              >
                {cert}
              </span>
            </div>
        ...
        <div>
          ...
          {projects.filter(Boolean).map((p, i) => (
            ...
            >
              ...
              <span
                style={{ fontSize: "10px", color: C.body, lineHeight: 1.6 }}
              >
                {p}
              </span>
            </div>
